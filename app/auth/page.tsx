      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Join the environmental revolution and start earning NFT rewards</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
          By signing up, you're joining a community of environmental champions making real impact through blockchain
          technology.
        </div>
      </div>
    </div>
