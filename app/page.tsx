      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">How Ecosystem 4.0 Works</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our blockchain-powered platform ensures transparency and rewards every environmental contribution
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>Participate in Projects</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base">
                  Join environmental conservation projects like tree planting, beach cleanup, and urban gardening
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-base">
                  Your contributions are verified and recorded on the blockchain, ensuring transparency and preventing
                  fraud.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>Earn NFT Rewards</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base">
                  Receive unique NFTs as proof of your environmental impact. Trade, collect, or showcase your
