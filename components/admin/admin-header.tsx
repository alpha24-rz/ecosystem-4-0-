    ...
    <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 h-16 flex items-center justify-between px-6">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input
            placeholder="Search users, projects, NFTs..."
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem>
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs text-gray-500">California Reforestation hit 70% completion</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col space-y-1">
                <p className="text-sm font-medium">NFT minting request</p>
                <p className="text-xs text-gray-500">5 new NFTs pending approval</p>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
